[![Maven Central](https://img.shields.io/maven-central/v/io.github.quillraven.libktx/ktx-textratypist.svg)](https://search.maven.org/artifact/io.github.quillraven.libktx/ktx-textratypist)

# KTX: `TextraTypist` type-safe builders

Utilities for creating [`TextraTypist`](https://github.com/tommyettinger/textratypist) animated text labels using Kotlin
type-safe builders.

## Why?

`TextraTypist` provides animated typewriter-style text rendering for Scene2D. It’s powerful for dialog boxes, narration,
RPG text, terminals, UI hints, and comic-style text effects.
...
The possibilities are nearly endless! See the [TextraTypist Wiki](https://github.com/tommyettinger/textratypist/wiki)
for a full list of supported tags and features.
